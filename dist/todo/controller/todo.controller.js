...
const todo_dto_request_1 = require("../service/dto/request/todo.dto.request");
let TodoController = class TodoController {
    constructor(todoService) {
        this.todoService = todoService;
    }
    async createTodo(memberId, todoRequest) {
        return await this.todoService.createTodo(todoRequest, memberId);
    }
    async deleteTodo(memberId, todoId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, todo_dto_request_1.TodoRequest]),
